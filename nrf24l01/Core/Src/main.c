...
int main(void)
{
  ...
  MX_SPI1_Init();
  	...
  	nrfTx.IRQ_port = NRF_IRQ_GPIO_Port;
  	nrfTx.IRQ_pin = NRF_IRQ_Pin;
  	nrfTx.hSPIx = &hspi1;
  	NRF24_Init(&nrfTx);
  ...
  while (1)
  {
	  tx_data[0] = HAL_GPIO_ReadPin(Boton1_GPIO_Port, Boton1_Pin);
	  		tx_data[1] = HAL_GPIO_ReadPin(Boton2_GPIO_Port, Boton2_Pin);
	  		tx_data[2] = HAL_GPIO_ReadPin(Boton3_GPIO_Port, Boton3_Pin);
